...
"
    ...
    let expected_stdout = format!(
        "tail: warning: --retry ignored; --retry is useful only when following{newline}{file_line}{newline}",
        file_line = file_line,
        newline = newline,
    );
    scene
    ...
    let expected_stdout = format!(
        "tail: warning: --retry only effective for the initial open{newline}{file_line}{newline}",
        file_line = file_line,
        newline = newline,
    );
    let mut child = scene
    ...
    let expected_stdout = format!(
        "tail: warning: PID ignored; --pid=PID is useful only when following{newline}{file_line}{newline}",
        file_line = file_line,
        newline = newline,
    );
    scene
    ...
    let expected_stdout = format!(
        "tail: warning: --retry ignored; --retry is useful only when following{newline}tail: warning: PID ignored; --pid=PID is useful only when following{newline}{file_line}{newline}",
        file_line = file_line,
        newline = newline,
    );
    scene
